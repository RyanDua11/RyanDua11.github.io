    ...
    pt: {
      ...
      blocks: [
        ...
        { t: 'gallery', label: 'Como está hoje', items: [
          ...
          { src: 'screens/02-home.png', caption: 'Home: missão do dia gerada a partir do plano de estudo' },
        ] },
        ...
        { t: 'diagram', label: 'Como a arquitetura funciona', nodes: [
          { title: 'Upload de PDF', desc: 'Aluna sobe aula ou prova antiga' },
          { title: 'Contexto por professor', desc: 'Material vira histórico ligado ao professor daquela turma' },
          { title: 'Resumo indexado', desc: 'Conteúdo resumido uma vez, PDF só é relido quando necessário' },
          { title: 'Orquestração de IA', desc: 'Claude, Groq e Gemini divididos por tipo de tarefa' },
          { title: 'Resposta ao grupo', desc: 'Caso clínico, prova ou explicação volta pra aluna e pro grupo' },
        ] },
    ...
    en: {
      ...
      blocks: [
        ...
        { t: 'gallery', label: 'How it looks today', items: [
          ...
          { src: 'screens/02-home.png', caption: "Home: today's mission generated from the study plan" },
        ] },
        ...
        { t: 'diagram', label: 'How the architecture works', nodes: [
          { title: 'PDF upload', desc: 'A student uploads a class or exam PDF' },
          { title: 'Per-professor context', desc: 'Material becomes history tied to that class’s professor' },
          { title: 'Indexed summary', desc: 'Content is summarized once, PDF is only re-read when needed' },
          { title: 'AI routing', desc: 'Claude, Groq and Gemini split by task type' },
          { title: 'Group response', desc: 'Clinical case, exam or explanation goes back to the student and group' },
        ] },
